                        ...
                        ?>
                            ...
                            if(isset($_POST['submit'])){
                                ...
                                if(!in_array($formatfile, $allowedtype)){
                                    ...
                                    echo '<div class="alert alert-error">Format file foto kepala sekolah tidak diizinkaan.</div>';

                                    return false;

                                }elseif($filesize > 1000000) {

                                    echo '<div class="alert alert-error">Ukuran file foto kepala sekolah tidak boleh dari 1MB.</div>';
