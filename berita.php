             ...
             <div class="content">
                ...
                <div class="container">
                    ...
                    <div class="box">
                        ...
                        <a href="tambah-berita.php" class="text-plus"><i class="fa fa-plus"></i>Tambah</a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="hapus.php?idberita=<?= $p['id'] ?>" onclick="return confirm('Yakin ingin di hapus ?')" title="Hapus Data" class="text-red" ><i class="fa fa-times"></i></a>
                                        </td>
                                    </tr>
                                    <?php }}else{ ?>
                                        <tr>
