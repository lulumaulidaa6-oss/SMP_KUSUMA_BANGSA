                        ...
                        <div class="box-body">
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="keterangan" placeholder="Keterangan" class="input-control" value="<?= $p->keterangan ?>" required>
                                </div>
                            ...
                            if(isset($_POST['submit'])){
                                ...
                                if(!in_array($formatfile, $allowedtype)){
                                    ...
                                    echo '<div class="alert alert-error">Format file tidak diizinkaan.</div>';

                                    return false;

                                }elseif($filesize > 1000000) {

                                    echo '<div class="alert alert-error">Ukuran file tidak boleh dari 1MB.</div>';
