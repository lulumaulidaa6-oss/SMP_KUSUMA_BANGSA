                        ...
                        ?>
                            ...
                            if(isset($_POST['submit'])){
                                ...
                                if(!in_array($formatfile, $allowedtype)){
                                    ...
                                    echo '<div class="alert alert-error">Format file foto sekolah tidak diizinkaan.</div>';

                                    return false;

                                }elseif($filesize > 1000000) {

                                    echo '<div class="alert alert-error">Ukuran file foto sekolah tidak boleh dari 1MB.</div>';

                                    return false;

                                }else{
                                    
                                    if(!empty($_POST['foto_lama']) && file_exists("../uploads/identitas/".$_POST['foto_lama']) && is_file("../uploads/identitas/".$_POST['foto_lama'])){
