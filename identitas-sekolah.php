                        ...
                        ?>
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="gmaps" class="input-control" placeholder="Google Maps"><?= $d->google_maps ?></textarea>
                                </div>
                            ...
                            if(isset($_POST['submit'])){
                                ...
                                if(!in_array($formatfile_logo, $allowedtype)){

                                    echo '<div class="alert alert-error">Format file logo sekolah tidak diizinkaan.</div>';

                                    return false;

                                }elseif($filesize_logo > 1000000) {

                                    echo '<div class="alert alert-error">Ukuran file logo sekolah tidak boleh dari 1MB.</div>';
                                ...
                                if(!in_array($formatfile_favicon, $allowedtype)){

                                    echo '<div class="alert alert-error">Format file favicon sekolah tidak diizinkaan.</div>';

                                    return false;

                                }elseif($filesize_favicon > 1000000) {

                                    echo '<div class="alert alert-error">Ukuran file favicon sekolah tidak boleh dari 1MB.</div>';
